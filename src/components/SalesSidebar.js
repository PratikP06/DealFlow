      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="px-5 py-5 border-b border-white/10">
            <h1 className="text-base font-bold text-white tracking-tight">DealFlow360</h1>
            <p className="text-[11px] text-slate-400 mt-0.5 font-medium uppercase tracking-wider">Sales Workspace</p>
          </div>
          ...
          {user?.role === 'ADMIN' && (
            <div className="px-3 pb-2">
              ...
              >
                <CogIcon className="w-[18px] h-[18px] flex-shrink-0" aria-hidden="true" />
                Admin Config
              </Link>
            </div>
          )}
...
function TruckIcon({ className }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.124-.504 1.124-1.125v-5.25c0-.621-.504-1.125-1.125-1.125h-3.5a1.125 1.125 0 01-1.062-.75l-1.14-3.417A1.125 1.125 0 0014.317 6H8.25m0 0v12" />
    </svg>
  )
}
